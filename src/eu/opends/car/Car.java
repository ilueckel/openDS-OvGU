...
public abstract class Car
{
    ...
    protected float lightIntensity = 0; //TODO: get value from scenario.xml
    ...
    protected void init()
    {
        ...
        sim.getRootNode().attachChild(carNode);
	...
	private void setupHeadlight(Simulator sim) 
	{
        ...
        sim.getRootNode().addLight(leftHeadLight);
        ...
        sim.getRootNode().addLight(rightHeadLight);
	}
